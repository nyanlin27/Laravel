...
<head>
    ...
    <!-- Favicon-->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('frontend_asset/favicon/apple-icon-57x57.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('frontend_asset/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('frontend_asset/favicon/apple-icon-72x72.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('frontend_asset/favicon/apple-icon-76x76.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('frontend_asset/favicon/apple-icon-114x114.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('frontend_asset/favicon/apple-icon-120x120.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('frontend_asset/favicon/apple-icon-144x144.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('frontend_asset/favicon/apple-icon-152x152.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('frontend_asset/favicon/apple-icon-180x180.png') }}">
    <link rel="icon" type="image/png" sizes="192x192"  href="{{ asset('frontend_asset/favicon/android-icon-192x192.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('frontend_asset/favicon/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('frontend_asset/favicon/favicon-96x96.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('frontend_asset/favicon/favicon-16x16.png') }}">

    <!-- iconfont CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/icon/icofont/icofont.min.css') }}">
    <!-- Boxicon CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/icon/boxicons-master/css/boxicons.min.css') }}">

    <!-- CUSTOM CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/css/font.css') }}">
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/css/media_query.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/css/owl.theme.default.css') }}">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
                ...
                <img src="{{ asset('frontend_asset/logo/logo.jpg') }}" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px">
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-10">
                         {{-- <a href="#"  class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right"> Login | Logout</a> --}}
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
                ...
                <img src="{{ asset('frontend_asset/image/download.png') }}" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px">
            </div>
        </div>
    </div>
    <div id="myPage"></div>
    ...
    <div id="mySidebar" class="sidebar">
        <div class="row">
            <div class="col-10">
                <img src="{{ asset('frontend_asset/logo/logo_med_trans.png') }}" class="img-fluid" style="width: 100px">
            </div>
            <div class="col-2">
        ...
        <div class="mt-3">
            ...
            <img src="{{ asset('frontend_asset/image/download.png') }}" class="img-fluid ml-2 text-center" style="width: 150px">
            <hr>

            <p class="text-white ml-3"> Copyright &copy; <img src="{{ asset('frontend_asset/logo/logo_wh_transparent.png') }}" style="width: 20px; height: 20px"> 2019  </p>
    ...
    <footer class="py-3 mt-5">
        <div class="container">
            ...
            <p class="m-0 text-center text-white">Copyright &copy; <img src="{{ asset('frontend_asset/logo/logo_wh_transparent.png') }}" style="width: 30px; height: 30px"> 2019</p>
        </div>
    </footer>
    ...
    <script type="text/javascript" src="{{ asset('frontend_asset/js/custom1.js') }}"></script>

    <!-- Owl Carousel -->
    <script type="text/javascript" src="{{ asset('frontend_asset/js/owl.carousel.js') }}"></script>
