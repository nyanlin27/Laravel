...
<main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i> Form Edit Subcategory</h1>
        <p>subcategory edit forms</p>
      </div>
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Forms</li>
        <li class="breadcrumb-item"><a href="#">Subcategory Edit Forms</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="tile-body">
            <form class="form-horizontal" method="POST" action="{{ route('subcategories.update', $subcategory->id) }}">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="Enter full name" name="name" value="{{ $subcategory->name }}">
                    @error('name')
